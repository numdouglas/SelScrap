...
public class SelScraper {
    ...
    public void setOptions() {
        System.setProperty("webdriver.chrome.driver","C:\\Users\\user\\IdeaProjects\\SelScrap\\src\\chromedriver.exe");
    ...
    private String betOnGudOddz(){
        ...
        do{
            try {
               ...
               if (Double.parseDouble(driver.findElement(By.xpath("//a[@class=\"l-account-links active\"]")).getText().replace("Account: ", "").replace(",","")) <= 1) {
